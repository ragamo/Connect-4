/**
 * Original code from @mennovanslooten
 * https://github.com/mennovanslooten/connect4/blob/gh-pages/js/c4.ai.js
 *
 * Uses the Alpha-Beta pruning
 */
export default function(_game, _player, _strength) {
	var _rack = _game.map;
	var _columns = _rack[0].length;
	var _rows = _rack.length;
	var _best_col = 0;
	_player.human = false;

	this.findBestCol = function() {
		alphabeta(_strength, -Infinity, Infinity, _player);
		return _best_col;
	}
